...
public class JoinManager {
    ...
    public void loadConfig() {
        ...
        quit = config.getString("messages.quit");
        firstJoin = config.getString("messages.first-join");
    }
    ...
    public boolean isSpawnOnJoinEnabled() {return spawnOnJoinEnabled;}
    public int getSpawnOnJoinId() {return spawnOnJoinId;}
    public boolean isFirstJoinSpawnEnabled() {return firstJoinSpawnEnabled;}
    public int getFirstJoinSpawnId() {return firstJoinSpawnId;}
